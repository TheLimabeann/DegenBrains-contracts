...
interface Logic {
    ...
    function zapIn(uint256 _pid, address _account, uint256 _amount, address _token) external;
...
contract DBFarms is Ownable, ERC721Holder {
    ...
    uint256 internal multiplier = 4000;
    uint256 internal rewardPerSecond = 2612000000000000000;
    ...
    function zapIn(uint256 _pid, address _account, uint256 _amount, address _token) public {
        Logic(logicContract).zapIn(_pid, _account, _amount, _token);
    }
